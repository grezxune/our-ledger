...
const TOAST_MESSAGES = {
  ...
  "unplanned-income-added": "Unplanned income source added.",
  "unplanned-income-removed": "Unplanned income source removed.",
  "one-off-expense-added": "One-off expense entry added.",
  "one-off-expense-removed": "One-off expense entry removed.",
  "account-balance-saved": "Account balance saved.",
  "account-balance-removed": "Account balance removed.",
  "credit-reconciliation-saved": "Credit card reconciliation saved.",
  "credit-reconciliation-removed": "Credit card reconciliation removed.",
